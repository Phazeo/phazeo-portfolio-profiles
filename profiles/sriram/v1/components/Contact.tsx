    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
            Open to opportunities in Generative AI, agentic workflows, and enterprise ML solutions.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          ...
          <a
            href="mailto:sriramsm01@gmail.com"
            className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 text-center group"
          >
            ...
            <p className="text-[var(--color-primary)] text-sm">sriramsm01@gmail.com</p>
          </a>
        </div>
      </div>
      ...
      <footer className="mt-16 pt-8 border-t border-gray-200">
        <p className="text-center text-gray-500 text-sm">
          © {new Date().getFullYear()} Sriram S M. All rights reserved.
        </p>
      </footer>
    </section>
  );
